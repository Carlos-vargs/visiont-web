...
import { Phone, MapPin, MessageSquare, X, AlertTriangle, Shield } from "lucide-react";

const contacts = [
  { id: 1, name: "María García", relation: "Familiar", phone: "+34 612 345 678", initials: "MG" },
  { id: 2, name: "Cruz Roja", relation: "Emergencias", phone: "112", initials: "CR", isEmergency: true },
  { id: 3, name: "Dr. Rodríguez", relation: "Médico", phone: "+34 698 765 432", initials: "DR" },
];
...
export function SOSView() {
  ...
  return (
    ...
    <div className="flex flex-col flex-1 overflow-y-auto pb-20" style={{ background: "#F8FAFC" }}>
      {/* SOS Main Button */}
      <div className="flex flex-col items-center pt-6 pb-4 px-5">
        ...
        <AnimatePresence mode="wait">
          {!sosActive ? (
            ...
            >
              <p style={{ fontSize: "15px" }} className="text-red-600 font-medium text-center">
                Enviando alerta en{" "}
            ...
            >
              <p style={{ fontSize: "15px" }} className="text-red-600 font-medium">
                ¡Alerta enviada!
              </p>
      ...
      <div className="mx-5 mb-4">
        <div className="flex items-center gap-2 mb-2 px-1">
          ...
          <p style={{ fontSize: "11px" }} className="text-gray-400 uppercase tracking-wider font-medium">
          ...
          {contacts.map((contact) => (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <p style={{ fontSize: "13px" }} className="text-slate-800 font-medium truncate">
                  {contact.name}
                </p>
