...
export function SettingsView() {
  ...
  return (
    <>
      <div className="flex flex-col flex-1 pb-20 overflow-scroll [scrollbar-width:none] [&::-webkit-scrollbar]:hidden" style={{ background: "#F8FAFC" }}>
      {/* Version / About */}
      <div className="mx-5 mt-3 mb-4 bg-gradient-to-br from-slate-900 to-slate-700 rounded-3xl p-4 flex items-center gap-3">
        ...
        <div>
          <p style={{ fontSize: "15px" }} className="text-white font-semibold">
            VisionAI
          </p>
              ...
              <div key={item.id}>
                <div className="flex items-center gap-3 px-4 py-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <p style={{ fontSize: "13px" }} className="text-slate-800 font-medium">
                      {item.label}
                    </p>
                    <p style={{ fontSize: "11px" }} className="text-gray-400 truncate">
                      {item.description}
                    </p>
                  </div>
                  {item.type === "toggle" ? (
